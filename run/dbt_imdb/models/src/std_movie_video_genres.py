...
def ref(*args, **kwargs):
    refs = {"std_genres": "\"imdb\".\"main\".\"std_genres\""}
    key = '.'.join(args)
...
class this:
    ...
    database = "imdb"
    schema = "main"
    identifier = "std_movie_video_genres"
    
    def __repr__(self):
        return '"imdb"."main"."std_movie_video_genres"'
...
def materialize(df, con):
    ...
    con.execute('create table "imdb"."main"."std_movie_video_genres__dbt_tmp" as select * from df')
