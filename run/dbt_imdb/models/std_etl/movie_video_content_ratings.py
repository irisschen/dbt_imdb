...
class this:
    ...
    database = "imdb"
    schema = "main"
    identifier = "movie_video_content_ratings"
    
    def __repr__(self):
        return '"imdb"."main"."movie_video_content_ratings"'
...
def materialize(df, con):
    ...
    con.execute('create table "imdb"."main"."movie_video_content_ratings__dbt_tmp" as select * from df')
